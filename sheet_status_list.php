                                ...
                                <div class="d-flex flex-grow-1 flex-stack flex-wrap gap-2 mb-n10" id="kt_toolbar">
                                    ...
                                    <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3" data-bs-toggle="modal" data-bs-target="#insert">
                                        <a type="button" class="btn btn-primary">
                                            <i class="bi bi-clipboard-plus-fill fs-4"></i> เพิ่มสถานะเอกสาร
                                        </a>
                                    </div>
                                    ...
                                    <div class="mb-18" style="padding: 15px;">
                                        ...
                                        <div class="mb-10">
                                            ...
                                            <div class="text-center mb-3">
                                                <h3 class="fs-2hx text-dark mb-5">รายการสถานะเอกสาร</h3>
                                            </div>
                                        </div>
                            ...
                            <div class="modal fade" id="insert" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    ...
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="staticBackdropLabel"><i class="fas fa-file-alt me-3 fs-4"></i> เพิ่มสถานะเอกสาร</h5>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                    </div>
                                    <div class="modal-body">
                                        <div class="mb-3">
                                            <label for="exampleFormControlInput1" class="form-label">ชื่อสถานะเอกสาร</label>
                                            <input type="email" class="form-control" id="name" placeholder="กรุณากรอกชื่อสถานะเอกสาร">
                                        </div>
                                    </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $(".edit-doc").click(function() {
                ...
                $.ajax({
                    url: "./get_status?token=" + token,
                    type: "POST",
                    data: { id: id },
                    success: function(res) {
                        console.log(res);
                        if (res.status == "success") {
                            $("#edit_name").val(res['data'].sheetstatus);
