...
<body id="kt_body" data-kt-app-header-stacked="true" data-kt-app-header-primary-enabled="true" data-kt-app-header-secondary-enabled="false" data-kt-app-toolbar-enabled="true" class="app-default">
                        ...
                        <div class="widget-box widget-color-green ui-sortable-handle">
                            ...
                            <div class=" widget-body">
                                <div class=" widget-main ms-6">
                                    ...
                                    <div class="mb-3 row">
                                        <label for="staticEmail" class="col-4 col-form-label text-end">ชื่อกผู้นำของออก</label>
                                        <div class="col-6">
    ...
    <script>
        $(document).ready(function() {
            ...
            if(UserSecurityID == '3' || UserSecurityID == '4'){
            ...
            function List_Logsheet(date_start, date_end, emp_code, emp_name) {
                $.ajax({
                    url: './Logsheet',
                    type: 'POST',
                    data: {
            ...
            $('#search').click(function() {
                ...
                window.location.href = "./test?token=" + token + "&date_start=" + date_start + "&date_end=" + date_end;
            });
